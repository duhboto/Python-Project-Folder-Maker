...
project_dir_label_value.pack()

project_dir_button = Button(window, text="Browse", font=("Arial", 12), bg="#4e4e4e", fg="#ffffff", activebackground="#43a047", activeforeground="#ffffff", command=create_project)
project_dir_button.pack()
increment_project_button = Button(window, text="Increment Project", font=("Arial", 12), bg="#4e4e4e", fg="#ffffff", activebackground="#43a047", activeforeground="#ffffff", command=increment_project)
increment_project_button.pack(pady=10)

create_project_button = Button(window, text="Create Project or Initialize Increment", font=("Arial", 12), bg="#4e4e4e", fg="#ffffff", activebackground="#43a047", activeforeground="#ffffff", command=create_project)
...
env_name_label.pack(pady=10)

env_name_entry = Entry(window, width=30, font=("Arial", 12))
env_name_entry.pack()

custom_folder_label = Label(window, text="Enter custom text to append to project (optional):", font=("Arial", 12), bg="#4e4e4e", fg="#ffffff")
custom_folder_label.pack(pady=10)

custom_folder_entry = Entry(window, width=30, font=("Arial", 12))
