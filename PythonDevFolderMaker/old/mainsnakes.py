...
image = Image.open("Image.png").resize((500, 600), Image.ANTIALIAS)
photo = ImageTk.PhotoImage(image)
canvas.create_image(0, 0, image=photo, anchor="nw")

# Place the other widgets on the canvas
...
# Place the Increment Project button
canvas.create_window(250, 240, window=increment_project_button)

# Place the Create Project button with added spacing
